...
function Hero2() {
  return (
    <section
      id="Home"
      className="flex flex-col  justify-start items-start h-[100vh] xl:h-auto pb-4 md:pb-8 bg-cover   bg-center bg-no-repeat mx-1 md:bg-[url('/Blob2.svg')]  rounded-2xl max-md:px-2 overflow-hidden"
    >
