...
import {Motionh1 , MotionDiv } from "./MotionDiv";
  ...
  function Reviews()  {
   ...
   <div id="Reviews" >
        <div>
            <Motionh1 className='font-Poppins text-stone-950 text-opacity-90 font-bold text-5xl sm:text-6xl lg:text-7xl pt-4 md:pt-12 lg:pt-20 lg:pb-20 pb-6  ml-8 md:ml-20 lg:ml-32 sm:w-3/4  lg:w-3/5 leading-tight md:leading-relaxed pr-2'
        ...
        <div className='flex flex-col justify-around items-center gap-2 h-dvh  relative'>
            <MotionDiv className='bg-white shadow-xl w-[80%] rounded-xl sticky top-[25%] mt-14'
              initial = {{opacity :0 ,y: 100}}
              whileInView = {{opacity:1,  y: 0}}
              viewport={{once:true}}
