    ...
    <footer className=" text-white  pb-2 md:pb-4 px-2 md:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl bg-zinc-950 pt-8   rounded-2xl">
        <div className="grid gap-6 md:gap-12">
          {/* Main CTA Section */}
          <div
            className="text-center max-xl:max-w-[90%] xl:max-w-5xl py-6 xl:py-10 mx-auto space-y-4 bg-background dark:bg-zinc-100 w-full rounded-2xl flex flex-col place-items-center"
            id="#CTA"
          >
