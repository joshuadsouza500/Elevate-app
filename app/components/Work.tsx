    ...
    <div id="Work"  className=' h-dvh w-full'>
      ...
      <div className='flex justify-center bg-background'>
       <div className="carousel w-[80%] rounded-lg shadow-xl">
        ...
        <div id="slide1" className="carousel-item relative w-full flex flex-col items-center md:flex md:flex-row py-5">
            <div className='flex flex-col justify-start  md:ml-16 lg:ml-20  pt-4 font-Poppins text-background2  '>  
                  <h3 className=' opacity-90 font-bold text-4xl  md:mt-4  md:mb-4 ' >RealMe.</h3>
        ...
        <div id="slide2" className="carousel-item relative w-full flex flex-col items-center md:flex md:flex-row py-5">
          <div className='flex flex-col justify-start md:ml-16 lg:ml-20 pt-4 font-Poppins text-background2  '>                 
             
                <h3 className=' opacity-90 font-bold text-4xl  md:mt-4  md:mb-4 ' >Star Solutions</h3>
